...
type AttachmentMetaResponse struct {
	...
	OgTags               *OGTagsResponse `json:"og_tags,omitempty"`
...
// Response Structure for AttachmentResponse
type AttachmentResponse struct {
	AttachmentType int                     `json:"attachment_type,omitempty"`
	AttachmentMeta *AttachmentMetaResponse `json:"attachment_meta,omitempty"`
	Type           enums.AttachmentType    `json:"type,omitempty"`
	MetaData       *AttachmentMetaResponse `json:"meta_data,omitempty"`
}
