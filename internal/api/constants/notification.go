...
const (
	...
	PostLikedSubCategory                = "%s %s"
	CommentLikedSubCategory             = "%s %s"
...
const (
	...
	PostLikedSubTitleLevelOne        = "%s %s your %s."
	PostLikedSubTitleLevelTwo        = "%s and 1 other %s your %s."
	PostLikedSubTitleLevelThree      = "%s and %d others %s your %s."
	CommentLikedSubTitleLevelOne     = "%s %s your %s."
	CommentLikedSubTitleLevelTwo     = "%s and 1 other %s your %s."
	CommentLikedSubTitleLevelThree   = "%s and %d others %s your %s."
