...
func (repository *postTopicsRepository) Aggregate(query []map[string]interface{}) ([]gin.H, error) {
	return _aggregateDocumentsInDB(repository.db, PostTopicsCollection, query)
}
